...
/* 0 */
/*!*************************************************************************************************!*\
  !*** C:/Users/will/Documents/GitHub/reference/新零售城市社交电商、网红探店小程序、多商户版（裂变分销+商家核验+集字卡片活动）/main.js ***!
  \*************************************************************************************************/
...
var _util = _interopRequireDefault(__webpack_require__(/*! utils/util */ 40));
...
var _http = _interopRequireDefault(__webpack_require__(/*! @/common/http.interceptor */ 42));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;} // @ts-ignore
wx.__webpack_require_UNI_MP_PLUGIN__ = __webpack_require__;_vue.default.use(_uviewUi.default); // utils
_vue.default.prototype.$util = _util.default; //全局注入w-loading组件
var wLoading = function wLoading() {__webpack_require__.e(/*! require.ensure | components/w-loading/w-loading */ "components/w-loading/w-loading").then((function () {return resolve(__webpack_require__(/*! @/components/w-loading/w-loading.vue */ 496));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};_vue.default.component('w-loading', wLoading); //分享
var mpShare = __webpack_require__(/*! node_modules/uview-ui/libs/mixin/mpShare.js */ 43);_vue.default.mixin(mpShare);_vue.default.config.productionTip = false;_App.default.mpType = 'app';var app = new _vue.default(_objectSpread({ store: _store.default }, _App.default)); // 请求全局封装
...
/* 6 */
/*!*************************************************************************************************!*\
  !*** C:/Users/will/Documents/GitHub/reference/新零售城市社交电商、网红探店小程序、多商户版（裂变分销+商家核验+集字卡片活动）/App.vue ***!
  \*************************************************************************************************/
/*! no static exports found */
...
/* 7 */
/*!**************************************************************************************************************************!*\
  !*** C:/Users/will/Documents/GitHub/reference/新零售城市社交电商、网红探店小程序、多商户版（裂变分销+商家核验+集字卡片活动）/App.vue?vue&type=script&lang=js& ***!
  \**************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 8 */
/*!*********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--12-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!C:/Users/will/Documents/GitHub/reference/新零售城市社交电商、网红探店小程序、多商户版（裂变分销+商家核验+集字卡片活动）/App.vue?vue&type=script&lang=js& ***!
  \*********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
{
  onLaunch: function onLaunch(_ref)

  {var _this = this;var query = _ref.query;
    ...
    {var data = _ref2.data;
      _this.$store.commit('writeBaseInfo', data);
    });
    // 获取当前登录状态
    uni.getStorage({
      key: 'token',
      ...
      {var data = _ref3.data;
        ...
        _this.$u.get('/api/user').
        then(function (_ref4)

        {var data = _ref4.data;
          _this.$store.commit('writeInfo', data);
        }).catch(function () {
...
/* 9 */
/*!***********************************************************************************************************************************!*\
  !*** C:/Users/will/Documents/GitHub/reference/新零售城市社交电商、网红探店小程序、多商户版（裂变分销+商家核验+集字卡片活动）/App.vue?vue&type=style&index=0&lang=scss& ***!
  \***********************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
