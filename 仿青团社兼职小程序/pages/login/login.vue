<template>
    <view>
        <view class="page">
            <view class="logway">
                <view :class="'act ' + (nowindex == index ? 'active' : '')" v-for="(item, index) in select" :key="index">
                    <view @tap="turntap" class="item ptp_exposure" :data-index="index" :data-num="index" data-ptpid="6f22-1fc6-9182-d53d">
                        {{ item }}
                    </view>
            ...
            <view class="tip-box">
                <view class="left">
                    <view class="title">Hi, 青团子</view>
                    <view class="subtext">登录注册解锁更多精彩内容</view>
                </view>
                <image lazyLoad class="tip-img" src="https://qiniu-image.qtshe.com/20200320login1.png"></image>
            </view>
            ...
            <view class="iagree">
                登录注册代表您已同意《
                <text @tap="skipAgreePage" class="green ptp_exposure" data-ptpid="934b-1839-b547-2d42">青团社用户协议</text>
                》
            </view>
        </view>
        ...
        <assist-touch></assist-touch>
    </view>
</template>

<script>
import assistTouch from '@/pages/components/assistTouch/assistTouch';
