<template>
	<view class="pageCont">
		<u-dropdown style="background-color: white;" ref="uDropdown" active-color="#f44c01">
			...
			<u-dropdown-item v-model="search.salary" title="薪资" :options="options2" @change="refload"></u-dropdown-item>
					...
					<view class="slot-cell">
						...
						<view class="gird">
							<view class="gitem" v-for="(item,index) in labelTag" :key="index"
								@click="seltag('label',item)" :class="{active:search.label_ids==item.value?true:false}">
