...
function genEventHandlerAttr(type) {
    return `data-e-` + type;
}
function addEventHandlers({ props }) {
    props.forEach((prop) => {
        ...
        if (!(0, uni_cli_shared_1.isSimpleExpressionNode)(arg) || !(0, uni_cli_shared_1.isSimpleExpressionNode)(exp)) {
            return;
        }
        // TODO 目前硬编码，仅限ready
        if (arg.content === 'ready') {
            props.push((0, uni_cli_shared_1.createBindDirectiveNode)(genEventHandlerAttr(arg.content), exp));
        }
    });
}
