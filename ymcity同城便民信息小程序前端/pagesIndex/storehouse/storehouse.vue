<template>
	<view class="pageCont">
		<u-dropdown style="background-color: white;" ref="uDropdown" active-color="#f44c01">
			<u-dropdown-item v-model="search.info_type" title="租售类型" :options="options1" @change="refload"></u-dropdown-item>
			<u-dropdown-item v-model="search.acreage" title="面积" :options="options2" @change="refload"></u-dropdown-item>
		</u-dropdown>
