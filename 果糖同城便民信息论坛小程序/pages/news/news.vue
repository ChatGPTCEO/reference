	...
	<view class="pageCont">
		<z-paging ref="paging" @query="queryList" :list.sync="newsList" style="height: 100%;width: 100%;">
			<view slot="loading">
				<view class="ymref">
					<view class="">
						<u-loading mode="circle" color="#ff5d37" size="80"></u-loading>
					</view>
				</view>
			</view>
			<view class="list">
				<view class="list-item" v-for="(item,index) in newsList" :key="index"
					...
					<view class="list-item-left" :style="{marginRight:item.images.length<3?'20rpx':'0'}">
						...
						<view class="list-item-imgs" v-if="item.images.length>=3">
							<u-image width="185rpx" height="185rpx" :src="item.images[0]" :lazy-load="true" border-radius="6"></u-image>
							<u-image width="185rpx" height="185rpx" :src="item.images[1]" :lazy-load="true" border-radius="6"></u-image>
							<u-image width="185rpx" height="185rpx" :src="item.images[2]" :lazy-load="true" border-radius="6"></u-image>
						</view>
					...
					<view class="list-item-right" v-if="item.images.length<3">
						<u-image width="220rpx" height="185rpx" :src="item.images[0]" :lazy-load="true" border-radius="6"></u-image>
					</view>
				</view>
			</view>
		</z-paging>
