<template>
	<view>
		...
		<view class="form">
			...
			<u-form-item label="车型" label-width="150rpx">
				<u-input v-model="form.car_type" placeholder="请输入" />
			</u-form-item>
			<u-form-item label="车牌号" label-width="150rpx">
				<u-input v-model="form.car_number" placeholder="请输入" />
			</u-form-item>
			<u-form-item label="空余座位" label-width="150rpx">
				<u-input v-model="form.seat_num" type="number" placeholder="请输入" />
			</u-form-item>
			...
			<u-form-item label="联系电话" label-width="150rpx">
				<u-input v-model="form.person_mobile" type="number" placeholder="请输入" />
			</u-form-item>
		...
		<u-picker v-model="gotimeShow" mode="time" @confirm="confiremRegtime" :params="params"></u-picker>
		...
		methods: {
			getCateFreeNum() {
				this.$u.get('/addons/hicity/user/getCateFreeNum', {
					...
					this.freenum = res.vipConfig.carpool_free_num;
