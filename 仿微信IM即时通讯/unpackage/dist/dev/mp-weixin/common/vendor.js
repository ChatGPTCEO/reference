...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_NAME":"仿微信IM即时通讯","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 5 */
/*!*********************************************************************!*\
  !*** C:/Users/will/Documents/GitHub/reference/仿微信IM即时通讯/pages.json ***!
  \*********************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 9 */
/*!******************************************************************!*\
  !*** C:/Users/will/Documents/GitHub/reference/仿微信IM即时通讯/core.js ***!
  \******************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ 4));
var _siteinfo = _interopRequireDefault(__webpack_require__(/*! @/siteinfo.js */ 10));
var _index = _interopRequireDefault(__webpack_require__(/*! @/store/index.js */ 11));
var _swasocket = _interopRequireDefault(__webpack_require__(/*! @/swasocket.js */ 13));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
var core = {
  agentid: 0,
  apitoken: '',
  platform: 'app',
  ...
  init: function init() {var userstate = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
    this.apitoken = _siteinfo.default.token;
    var that = this;
  ...
  initsys: function initsys() {var userstate = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';var callback = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
    var postdata = { v: this.version };
    if (userstate != '') {
  ...
  initsocket: function initsocket() {var usersign = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    ...
    //引入
    _swasocket.default.UserSign = usersign;
    ...
    Socket = uni.connectSocket({
      ...
      success: function success(res) {
        //console.log(res);
        _swasocket.default.Connected = true;
      } });

    uni.onSocketOpen(function (res) {
      Socket.connected = true;
      _swasocket.default.Send({
        "Method": "User/Connect",
        "Type": 0,
    ...
    uni.onSocketMessage(function (res) {
      ...
      if (typeof data.data.message != 'undefined') {
        var socketdata = JSON.parse(data.data.message);
        return _swasocket.default.Received(socketdata);
      }
    });
    ...
    Socket.connected = false;
    _swasocket.default.Socket = Socket;
    _swasocket.default.Core = this;
  },
  initshare: function initshare(title, url) {var cover = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '';var summary = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : '';
    var ShareObject = {
      title: title,
      url: url,
      cover: cover,
  ...
  initjwx: function initjwx(callback) {var debug = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
    console.log('当前版本不支持微信JS-SDK，请联系作者购买完整版');
  },
  login: function login(data) {var cache = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
    if (!data.uid) return this.toast('Unknown UID');
    this.userinfo = data;
    _index.default.commit('login', data);
    this.inituser();
    if (cache) {
  ...
  logout: function logout() {
    ...
    if (this.userinfo.uid > 0) {
      var cachekey = '_xfy_whotalk_face_' + this.userinfo.uid;
      uni.removeStorage({ key: cachekey, success: function success() {
          console.log('成功删除本地表情缓存');
        } });
    }
    this.userinfo = { uid: 0, token: '' };
    //退出socket
    _swasocket.default.Logout(this.system.socket.type);
    var system_session = { system: this.system, member: this.userinfo, style: this.style, langs: this.langs };
    this.cacheset('_xfy_whotalk_system_session_', system_session);
  ...
  copy: function copy() {var text = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';var toast = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '已复制到剪切板';
  ...
  cachecloud: function cachecloud(cname, callback) {var nocache = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
    var cachekey = '_xfy_whotalk_' + cname + '_';
    var loadcloud = function loadcloud() {
  ...
  cacheread: function cacheread(key, callback, fail) {
    var cachekey = key + '_' + _siteinfo.default.uniacid;
    var getstorage = { key: cachekey };
    if (typeof callback == 'function') {
  ...
  cacheset: function cacheset(key, data) {
    var cachekey = key + '_' + _siteinfo.default.uniacid;
    uni.setStorage({ key: cachekey, data: data, fail: function fail(e) {
        console.log('写入缓存失败：');
        console.log(e);
      }, success: function success() {
        //console.log('写入缓存成功！');
  ...
  confirm: function confirm(msg, title, callback) {var options = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};var Cancel = arguments.length > 4 ? arguments[4] : undefined;
    options = options || {};
    options.content = msg;
  ...
  get: function get(u, c, d, t, l) {
    return this.request(u, 'GET', d, t, c, l);
  },
  post: function post(u, c, d, t, l) {
    return this.request(u, 'POST', d, t, c, l);
  },
  url: function url() {var route = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "";var action = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'api';
    route = route.replace('/', '.');
    if (route.indexOf('http') == 0 || route.indexOf('/index.php') > -1) return route;
    var baseurl = _siteinfo.default.siteroot + '?i=' + _siteinfo.default.uniacid + '&m=xfy_whotalk';
    if (action == 'api') {
  ...
  page: function page() {var url = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'index/index';var data = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    if (url == '' || url == '#' || url.indexOf('javascript:') == 0) return '';
    // ***#/pages/***
    if (url.indexOf('#/pages/') > 0) {
      var urls = url.split('#/pages/');
      url = urls[1];
    } else {
      // *** /#/pages/ ***
  ...
  upload: function upload(file, callback) {var type = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "image";var apiname = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : "attach/upload";
    var res = {
  ...
  navito: function navito() {var page = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';var data = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};var type = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
  ...
  request: function request(u, m, d, t, c, l) {
    var url = this.url(u);
    var method = m ? m : 'GET';
    var data = d ? d : {};
  ...
  report: function report(res) {var initpage = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
...
/* 10 */
/*!**********************************************************************!*\
  !*** C:/Users/will/Documents/GitHub/reference/仿微信IM即时通讯/siteinfo.js ***!
  \**********************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
var siteinfo = {
  ...
  'multiid': '10000',
  'version': '1.1.30',
  'siteroot': 'https://chat.gxit.org/app/index.php',
  'token': 'fKxcduIcjL3euIuN1Xvt2iRRvyV1ujUf' };
...
/* 11 */
/*!*************************************************************************!*\
  !*** C:/Users/will/Documents/GitHub/reference/仿微信IM即时通讯/store/index.js ***!
  \*************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var store = new _vuex.default.Store({
  ...
  mutations: {
    readmsg: function readmsg(state) {var isclear = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
      if (isclear) {
        state.newMsg = 0;
      } else {
        state.newMsg -= 1;
    ...
    setnewmsg: function setnewmsg(state) {var news = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
      state.newMsg = news;
      if (typeof plus != 'undefined') {
        plus.runtime.setBadgeNumber(news);
      }
    },
    chatinit: function chatinit(state, dialog) {
      state.Chatid = dialog.cid;
      state.Chattype = dialog.type;
    },
    getnewmsg: function getnewmsg(state) {
      state.newMsg += 1;
      if (typeof plus != 'undefined') {
        plus.runtime.setBadgeNumber(state.newMsg);
      }
...
/* 13 */
/*!***********************************************************************!*\
  !*** C:/Users/will/Documents/GitHub/reference/仿微信IM即时通讯/swasocket.js ***!
  \***********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

/* WEBPACK VAR INJECTION */(function(uni) {var innerAudioContext = uni.createInnerAudioContext();
var swasocket = {
  Handels: {
    "mainpage": null,
    "dialog": null,
  ...
  Logout: function Logout() {var type = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'local';
    if (type == 'local') {
  ...
  Received: function Received(socketdata) {
    for (var i in this.Handels) {
      var handel = this.Handels[i];
  ...
  Send: function Send() {var socketdata = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};var scktype = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'local';var server = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '';
    if (scktype == 'local') {
      ...
      var promise = this.Socket.sendMessage(socketdata);
  ...
  TimREVOKED: function TimREVOKED(event) {
    // 收到消息被撤回的通知
    console.log(event.data);
  },
  TIMSdkReady: function TIMSdkReady(event) {
    // TIM接口初始化完成调用
    this.Ready(event);
  } };
