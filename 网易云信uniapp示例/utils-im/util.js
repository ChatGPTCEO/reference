...
function calcTimeHeader(time) {
  ...
  let beforeYesterday = new Date(currentDate - 24 * 3600 * 1000 * 2)
  ...
  } else if (year == beforeYesterday.getUTCFullYear() && month == beforeYesterday.getUTCMonth() && day == beforeYesterday.getDate()) { //前天
