  ...
  <view class="">
    <view class="u-navbar" :style="[navbarStyle]" :class="{ 'u-navbar-fixed': isFixed, 'u-border-bottom': borderBottom }">
      ...
      <view class="u-navbar-inner" :style="[navbarInnerStyle]">
        <view class="u-back-wrap flex-row-sb-center" v-if="isBack">
          <view class="u-icon-wrap flex-center-center" @tap="goBack">
            <img :src="iconBack" alt="">
          </view>
          <div class="gray-col-line"></div>
          <view class="u-icon-wrap flex-center-center" @click="goHome">
        ...
        <view class="u-navbar-content-title" v-if="title" :style="[titleStyle]">
          <view class="u-title u-line-1" :style="{
            ...
            <view v-if="subTitle" class="text-ellipsis-nowarp" style="color:#666666;font-size:24rpx;width:260rpx">
              {{ subTitle }}
            </view>
          </view>
        </view>
...
export default {
  ...
  data() {
    return {
      config: config,
      iconBack: `${config.imgSrc}icon-nav-back.png`,
      iconHome: `${config.imgSrc}icon-nav-home.png`,
      menuButtonInfo: menuButtonInfo,
      statusBarHeight: systemInfo.statusBarHeight || 40 + 'px'
    }
  },
  computed: {
    // 导航栏内部盒子的样式
    navbarInnerStyle() {
      ...
      style.height = (this.navbarHeight || 48) + 'px'
