<template>
	<view class="raw">
		<view class="scan_top">
		<uni-icons type="arrowleft" size="25" ></uni-icons><!-- uni-icons是引入的官房图标组，位置：components/uni-icons -->
		<!-- 搜索框 -->
		<view class="inputp">
			<view class="inputs">
		...
		<view class="record">
			<view class="record_heand">
				<text >搜索历史</text>
				<image class="iconfont icon-shanchu" @click="delete_key"></image><!-- 点击历史记录直接执行搜索 -->
			</view>
			<!-- 搜索历史内容 -->
		...
		<view class="record">
			<view class="record_heand">
				<text >热门搜索</text>
				<image :class="'iconfont' + ' icon-yanjing'+forbid" @tap="hotToggle"></image><!-- ：class:判断是否点击，每次点击会改变绑定的字段(也可以是样式)，根据字段不同展示不同的图标	自定义图标在style	 -->		
			</view>
			<!-- 搜索热门内容 -->
