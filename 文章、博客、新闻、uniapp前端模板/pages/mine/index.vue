<template>
	<view>
		...
		<view class="u-m-t-20">
			<u-cell-group>
				<u-cell-item icon="calendar" :iconStyle="iconStyle" title="签到" @click="calendarClick"></u-cell-item>
				...
				<u-cell-item icon="fingerprint" :iconStyle="iconStyle" title="足迹" @click="toUrl('/pages/mine/foot')"></u-cell-item>
				<u-cell-item icon="file-text" :iconStyle="iconStyle" title="反馈" @click="toUrl('/pages/mine/feedback')"></u-cell-item>
		...
		<view class="u-m-t-20">
			<u-cell-group>
				<u-cell-item icon="setting" :iconStyle="iconStyle" title="设置" @click="toUrl('/pages/mine/setting')"></u-cell-item>
			</u-cell-group>
		</view>
		<!-- 签到弹窗 -->
		<u-popup v-model="show" borderRadius="20" mode="center" length="50%">
			<view class="pupbox">
				<view class="box-icon u-flex u-row-center">
					<view><u-icon name="gift-fill" size="158" color="#F05C52"></u-icon></view>
				</view>
