<template>
	<view>
		...
		<view class="form">
			<u-tabs :list="tabs" height="100" active-color="#ff5d37" :is-scroll="false" :current="current"
				@change="changeTab"></u-tabs>
			<u-line color="#e4e7ed" />
			<u-form v-if="current==0" :model="model" ref="uForm" :errorType="errorType">
				<u-form-item :label-position="labelPosition" label="手机号码" prop="mobile" label-width="150" :border-bottom="false">
			...
			<view class="agreement">
				...
				<view class="agreement-text">
					勾选代表同意果糖同城的<text style="color: #ff5d37;" @click="$u.route('/pagesUser/textmain/textmain',{id:3})">《用户协议》</text>
				</view>
			</view>
		</view>
		...
		<view class="otherlogin">
			...
			<view class="appwx" @click="wxlogin">
				<view class="u-icon-wechat-fill newicon-normal"></view>
			</view>
		</view>
	</view>
</template>
