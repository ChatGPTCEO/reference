<template>
	<view class="content reg-page">
		<view class="input-group">
			...
			<view class="input-row border-bottom-1px" @click="authSuccess==false && uploadImg()">
				...
				<view class="align-height row">
					...
					<text class="yzb yzb-next" v-if="authSuccess==false"></text>
				</view>
			</view>
			<view class="input-row border-bottom-1px">
				<text class="title">公司名称</text>
				<view class="input-row-item">
					<input class="padding-10" :disabled="authSuccess?true:false" v-model="company.name" />
					<text class="yzb yzb-next" v-if="authSuccess==false"></text>
				</view>
			</view>
			<view class="input-row border-bottom-1px">
				...
				<view class="input-row-item">
					<input class="padding-10" :disabled="authSuccess?true:false" v-model="company.fullName" />
					<text class="yzb yzb-next" v-if="authSuccess==false"></text>
				</view>
			</view>
			<view class="input-row border-bottom-1px" @click="authSuccess==false && toIndustry()">
				<text class="title">所属行业</text>
				<view class="input-row-item">
					<input class="padding-10" disabled="true" v-model="company.industryName" />
					<text class="yzb yzb-next" v-if="authSuccess==false"></text>
				</view>
			</view>
			<view class="input-row border-bottom-1px">
				...
				<view class="picker row align-width">
					<picker @change="bindNaturePickerChange" :disabled="authSuccess?true:false" :value="company.nature" :range="natures">
						<input class="padding-10" disabled="true" style="text-align: right;" placeholder="请选择公司性质" :value="company.nature" />
					</picker>
					<text class="yzb yzb-next" v-if="authSuccess==false"></text>
				</view>
			</view>
			<view class="input-row border-bottom-1px">
				...
				<view class="picker row align-width">
					<picker @change="bindPickerChange" :disabled="authSuccess?true:false" :value="company.staffSize" :range="array">
						<input class="padding-10" disabled="true" style="text-align: right;" placeholder="" :value="company.staffSize" />
					</picker>
					<text class="yzb yzb-next" v-if="authSuccess==false"></text>
				</view>
			</view>
			...
			<view class="input-column border-bottom-1px">
				...
				<view class="row space-between-algin">
					<picker mode="time" v-model="company.startTime" @change="bindDate1Change">
						<input disabled="true" class="padding-10" placeholder="开始时间" :value="company.startTime" />
					</picker>
					至
					<picker mode="time" v-model="company.endTime" @change="bindDate2Change">
						<input disabled="true" class="padding-10" style="text-align: center;" placeholder="结束时间" :value="company.endTime" />
					</picker>
				</view>
			</view>
			<view class="input-column border-bottom-1px">
			...
			<text class="padding-width-10 text-color-grey text-size-base">建议上传400*200或宽高比例2:1左右的图片</text>
